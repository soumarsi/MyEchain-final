...
@interface QTStatic_cardViewController ()

@end

@implementation QTStatic_cardViewController
...
- (void)viewDidLoad
{
    ...
    NSLog(@"QTStatic_cardViewController");
    ...
    cardimg=[[UIImageView alloc]initWithFrame:CGRectMake([[UIScreen mainScreen]bounds].size.width/2-35,17, 57, 57)];
      [cardimg sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://esolz.co.in/lab1/Web/myEchain/logoimage/thumb/staticimage1.png"]] placeholderImage:[UIImage imageNamed:@"logo-1.png"] options:0 == 0?SDWebImageRefreshCached : 0];
