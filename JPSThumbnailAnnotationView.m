...
@property (nonatomic, strong) ActionBlock disclosureBlock1;
@property (nonatomic, strong) CAShapeLayer *bgLayer;
@property (nonatomic, strong) UIButton *disclosureButton;
@property (nonatomic, assign) JPSThumbnailAnnotationViewState state;
@property(nonatomic,readwrite)UIButton *StarBtn;
...
- (void)setupTitleLabel {
    _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(-32.0f, 6.0f, 168.0f, 30.0f)];
    ...
    UITapGestureRecognizer *lbltap = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(titlebuttonpressed)];
    [_titleLabel addGestureRecognizer:lbltap];
...
- (void)setupSubtitleLabel {
    ...
    UITapGestureRecognizer *lbltap = [[UITapGestureRecognizer alloc]initWithTarget:self action:@selector(titlebuttonpressed)];
    [_subtitleLabel addGestureRecognizer:lbltap];
...
- (void)updateWithThumbnail:(JPSThumbnail *)thumbnail {
    ...
    self.rankint = thumbnail.rank;
    self.disclosureBlock = thumbnail.disclosureBlock;
    self.disclosureBlock1 = thumbnail.disclosureBlock1;
    ...
    if (self.imageView.image == nil) {
        ...
        _imagelbl = [[UILabel alloc]initWithFrame:CGRectMake(0,0,50.0f, 47.0f)];
        [_imagelbl setBackgroundColor:[UIColor whiteColor]];
        [_imagelbl setTextColor:[UIColor blackColor]];
        _imagelbl.numberOfLines = 3;
        _imagelbl.font = [UIFont systemFontOfSize:10];
        _imagelbl.text = _titleLabel.text;
        [_imageView addSubview:_imagelbl];
...
-(void)titlebuttonpressed{
    ...
    if (self.disclosureBlock1) self.disclosureBlock1();
