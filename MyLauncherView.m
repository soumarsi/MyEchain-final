...
//                    
//                    urlString1 =[NSString stringWithFormat:@"%@delete_card.php?card_id=%@",APPS_DOMAIN_URL,[[obj1.cardarray objectAtIndex:i]objectForKey:@"card_id"]];  //
//                    
