...
-(id)initWithTitle:(NSString *)title image:(NSString *)image target:(NSString *)targetControllerStr cardno:(NSString *)cardnohome deletable:(BOOL)_deletable {
...
-(id)initWithTitle:(NSString *)title iPhoneImage:(NSString *)image iPadImage:(NSString *)iPadImage target:(NSString *)targetControllerStr targetTitle:(NSString *)targetTitle cardno:(NSString *)cardnohome deletable:(BOOL)_deletable {
...
-(void)layoutItem
{
    ...
    [itemImage sd_setImageWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",self.image]] placeholderImage:[UIImage imageNamed:@"placeimage"] options:0 == 0?SDWebImageRefreshCached : 0 ];
	CGFloat itemImageX = (self.bounds.size.width/2) - (57/2);
	CGFloat itemImageY = (self.bounds.size.height/2) - (57/2);
	itemImage.frame = CGRectMake(itemImageX, itemImageY, 57,57);
	[self addSubview:itemImage];
    CGFloat itemImageWidth = itemImage.bounds.size.width;
itemImage.layer.cornerRadius = 5.0f;
